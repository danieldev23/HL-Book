            ...
            <div class="colm-form">
                <div class="form-container">
                    ...
                    <div class="text-field">
                        ...
                        <input autocomplete="off" name="username" type="text" id="username3" placeholder="Enter your username" />

                      </div>
                      <div class="text-field" style="margin-top: 13px">
                        <label for="username3">Name</label>
                        <input autocomplete="off" name="name" type="text" id="username3" placeholder="Enter your name" />

                      </div>                               
                      <div class="text-field" style="margin-top: 13px">
                        <label for="username3">Your birthday</label>
                        <input autocomplete="off" name="birthday" type="text" id="username3" placeholder="Enter your birthday" />

                      </div>                                         
                      <div class="text-field" style="margin-top: 13px">
                        <label for="username3">Email</label>
                        <input autocomplete="off" name="email" type="email" id="username3" placeholder="Enter your email" />
