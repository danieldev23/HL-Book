                ...
                <div>
                    <h3>
                        ...
                        <div class="famous">
                            ...
                            <p class="check">Huy hiệu đã xác minh xác nhận đây là Trang cá nhân xác thực của người của
                                công chúng</p>
                        </div>
                    </h3>
    ...
    <div class="profile-info">
        <div class="info-col">
            <div class="profile-intro">
                <h3>Intro</h3>
                <p class="intro-text">Very little is needed to make a happy life, it is all within yourself, in your way
                    of thinking.</p>
                <hr>
                <ul>
                    ...
                    <li><img class="x1b0d499 xuo83w3" width="15px"
                             src="https://static.xx.fbcdn.net/rsrc.php/v3/yJ/r/OyWm6cSjuMt.png"> Followed by 113.519.283
                        people
                    </li>
                    <li><img class="x1b0d499 xuo83w3" src="https://static.xx.fbcdn.net/rsrc.php/v3/yV/r/ufIMw_ngzRh.png"
                             width="15"> <a href="" style="text-decoration: none;">danieldev23</a></li>
                </ul>
            </div>
            ...
            <div class="profile-intro">
                ...
                <div class="friends-box">
                    <div><img src="{{asset('frontend/images/mycrush.jpg')}}">
                        <p>Li Nh</p></div>
                    <div><img src="{{asset('frontend/images/nhat.jpg')}}">
                        <p>Nhật</p></div>
                    <div><img src="{{asset('frontend/images/me.jpg')}}">
                        <p>Huy</p></div>
                    <div><img src="{{asset('frontend/images/huyenngu.jpg')}}">Huyền</div>
                    <div><img src="{{asset('frontend/images/user.jpg')}}">
                        <p>D.Q.Huy</p></div>
                    <div><img src="{{asset('frontend/images/manhezai.jpg')}}">
                        <p>Mạnh</p></div>
      ...
      <textarea
          ...
          placeholder="What's on your mind, Huy?">
                        ...
                        <button class="btn-post"><img style="margin:  0" src="{{asset('frontend/images/new-post.png')}}"
                                                      width="16px">Post
                        </button>
